(function(){
  ...
  function buildExportSurfaceV106(){
    ...
    root.innerHTML=`<div class="v105-export-surface"><div class="v105-export-head"><div class="v105-export-title">Business Map <span style="font-size:16px;color:#3478f6">${VERSION}</span></div><div class="v105-export-date">保存日時：${new Date().toLocaleString('ja-JP')}</div></div><div class="v105-export-map"><div class="v105-export-info"><div class="v105-export-info-title">チーム情報</div><div class="v105-export-grid"><div class="v105-export-pill"><div class="l">目標PV</div><div class="v">${fmt(s.teamTarget)}</div></div><div class="v105-export-pill"><div class="l">実績PV</div><div class="v">${fmt(s.teamActual)}</div></div><div class="v105-export-pill"><div class="l">達成率</div><div class="v">${s.rate}%</div></div><div class="v105-export-pill"><div class="l">登録人数</div><div class="v">${s.peopleCount}人</div></div><div class="v105-export-pill"><div class="l">ABO</div><div class="v">${s.typeCount['ABO']||0}人</div></div><div class="v105-export-pill"><div class="l">C/P/小売</div><div class="v">${s.typeCount['カスタマー']||0}/${s.typeCount['プロスペ']||0}/${s.typeCount['小売']||0}</div></div></div><div class="v105-export-statuses">${chips}</div></div><div id="v106ExportMap"></div></div></div>`;
